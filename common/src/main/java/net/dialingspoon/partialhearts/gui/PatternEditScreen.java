...
public class PatternEditScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new ArrowButton(width / 2 - 6 * BUTTON_SIZE - 32, topOffset + 4 * BUTTON_SIZE - 16, 32, 32,
                new ResourceLocation(PartialHearts.MOD_ID, "textures/gui/sprites/scroll_left.png"), b -> decrementSpriteIndex()));

        this.addRenderableWidget(new ArrowButton(width / 2 + 6 * BUTTON_SIZE, topOffset + 4 * BUTTON_SIZE - 16, 32, 32,
                new ResourceLocation(PartialHearts.MOD_ID, "textures/gui/sprites/scroll_right.png"), b -> incrementSpriteIndex()));
    ...
    public void render(GuiGraphics gg, int mouseX, int mouseY, float partialTicks) {
        ...
        gg.blit(new ResourceLocation("textures/gui/icons.png"), leftOffset, topOffset, GRID_SIZE*BUTTON_SIZE, GRID_SIZE*BUTTON_SIZE, heartType.getX(false, blinking), hardcore ? 45 : 0, 9, 9, 256, 256);
