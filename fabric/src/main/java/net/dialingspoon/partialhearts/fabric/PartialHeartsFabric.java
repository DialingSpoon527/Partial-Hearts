...
public final class PartialHeartsFabric implements ClientModInitializer {
    ...
    public static void onShaderReload(CoreShaderRegistrationCallback.RegistrationContext context) throws IOException {
        ...
        if (FabricLoader.getInstance().isModLoaded("colorfulhearts"))
            context.register(new ResourceLocation("partialhearts", "heart_mask_color"), DefaultVertexFormat.POSITION_COLOR_TEX, shader -> PartialHearts.COLOR_SHADER = shader);
    }
}
